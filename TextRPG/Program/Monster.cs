...
namespace TextRPG.MonsterManagement
{
    public class Monster
    {
        ...
        public static void InitMonsters()
        {
            ...
            Monster monster3 = new Monster("임차장", 3, 26, 8, 7, 70, 15, 3, 120, 250, new List<string> { "차장의 넥타이" });
            Monster monster4 = new Monster("김부장", 4, 24, 11, 5, 70, 25, 4, 150, 300, new List<string> { "부장의 가발" });
            ...
            Monster monster7 = new Monster("유상무", 7, 43, 25, 18, 75, 30, 7, 400, 700, new List<string> { "노또 용지" });
            Monster monster8 = new Monster("최전무", 8, 50, 22, 20, 80, 40, 8, 500, 800, new List<string> { "자서전" });
            Monster monster9 = new Monster("석회장", 9, 250, 40, 28, 90, 35, 10, 2000, 3000, new List<string> { "직급 명패" });
