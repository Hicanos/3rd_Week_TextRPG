...
namespace TextRPG.MonsterManagement
{
    public class Monster
    {
        ...
        public Monster(string name, int level, int attack, int defense , int health , int dex , int eva , int exp = 0, int gold = 0, List<string> dropItems = null)
        {
            Name = name;
            Level = level;
            Attack = attack;
        ...
        public static void InitMonsters()
        {
            ...
            Monster monster1 = new Monster("송 대리", 1 , 2 , 3 , 5 , 30 , 10 , 1 , 200 , new List<string> { "포션" }); // 몬스터 종류와 정보
            Monster monster2 = new Monster("조 차장", 2 , 3 , 5 , 9 , 35 , 12 , 2 , 300 , new List<string> { "포션" });
            Monster monster3 = new Monster("전 부장", 3 , 5 , 7 , 15 , 40 , 15 , 3 , 400, new List<string> { "포션" });
            Monster monster4 = new Monster("이 실장", 4 , 7 , 10 , 20 , 45 , 17 , 4 , 500, new List<string> { "포션" });
            Monster monster5 = new Monster("석 이사", 5 , 15 , 15 , 25 , 50 , 19 , 5 , 600, new List<string> { "포션" });
            Monster monster6 = new Monster("노 상무", 6 , 17 , 20 , 30 , 60 , 20 , 6 , 700, new List<string> { "포션" });
            Monster monster7 = new Monster("송 전무", 7 , 20 , 23 , 35 , 70 , 22 , 7 , 800, new List<string> { "포션" });
            Monster monster8 = new Monster("조 사장", 8 , 25 , 25 , 50 , 80 , 25 , 8 , 1000, new List<string> { "포션" });
            Monster monster9 = new Monster("석 회장", 10 , 40 , 30 , 100 , 90 , 30 , 10 , 2000, new List<string> { "포션" });
